...
class SimpleBot:
    def __init__(self):
        ...
        self.best_assets = [
            ...
            "EURNZD-OTC", "USDSEK-OTC", "USDTRY-OTC", "USDPLN-OTC", 
            "AUDCHF-OTC", "AUDNZD-OTC", "EURCHF-OTC", "GBPNZD-OTC", 
            "CADJPY-OTC", "NZDCAD-OTC", "NZDJPY-OTC", "CHFNOK-OTC", 
            "NOKJPY-OTC", "NZDCHF-OTC", "EURTHB-OTC", "USDTHB-OTC", 
            "JPYTHB-OTC", "EURGBP_GS",

            # Stocks (Ações)
            "GOOGLE-OTC", "AMAZON-OTC", "TESLA-OTC", "FB-OTC", "APPLE-OTC", 
            "Reddit", "AMZN/ALIBABA-OTC", "AMZN/EBAY-OTC", "NVDA/AMD-OTC", 
            "GOOGLE/MSFT-OTC", "TESLA/FORD-OTC", "MSFT/AAPL-OTC", "INTEL/IBM-OTC", 
            "NFLX/AMZN-OTC", "META/GOOGLE-OTC", "BIDU-OTC", "INTEL-OTC", 
            "MSFT-OTC", "CITI-OTC", "COKE-OTC", "JPM-OTC", "MCDON-OTC", 
            "MORSTAN-OTC", "NIKE-OTC", "ALIBABA-OTC", "AIG-OTC", "GS-OTC", 
            "SNAP-OTC",

            # Crypto
            "ETHUSD-OTC", "SOLUSD-OTC", "TON/USD-OTC", "NOTCOIN-OTC", 
            "XRPUSD-OTC", "LTCUSD-OTC", "EOSUSD-OTC", "ICPUSD-OTC", 
            "IMXUSD-OTC", "JUPUSD-OTC", "BONKUSD-OTC", "LINKUSD-OTC", 
            "WIFUSD-OTC", "PEPEUSD-OTC", "FLOKIUSD-OTC", "GALAUSD-OTC", 
            "BCHUSD-OTC", "DOTUSD-OTC", "ATOMUSD-OTC", "INJUSD-OTC", 
            "SEIUSD-OTC", "IOTAUSD-OTC", "BEAMUSD-OTC", "DASHUSD-OTC", 
            "ARBUSD-OTC", "WLDUSD-OTC", "ORDIUSD-OTC", "SATSUSD-OTC", 
            "PYTHUSD-OTC", "RONINUSD-OTC", "TIAUSD-OTC", "MANAUSD-OTC", 
            "SANDUSD-OTC", "GRTUSD-OTC", "STXUSD-OTC", "MATICUSD-OTC", 
            "NEARUSD-OTC", "HMSTR-OTC", "BTCUSD-OTC-op", "ONDOUSD-OTC", 
            "DYDXUSD-OTC", "ONYXCOINUSD-OTC", "FARTCOINUSD-OTC", "PENGUUSD-OTC", 
            "RAYDIUMUSD-OTC", "SUIUSD-OTC", "HBARUSD-OTC", "FETUSD-OTC", 
            "RENDERUSD-OTC", "TAOUSD-OTC", "TRUMPUSD-OTC", "MELANIAUSD-OTC",

            # Indices & Commodities
            "SP500-OTC", "USNDAQ100-OTC", "US30-OTC", "SP35-OTC", "FR40-OTC", 
            "GER30-OTC", "UK100-OTC", "AUS200-OTC", "HK33-OTC", "EU50-OTC", 
            "JP225-OTC", "US30/JP225-OTC", "US100/JP225-OTC", "US500/JP225-OTC", 
            "XAU/XAG-OTC", "GER30/UK100-OTC", "US2000-OTC", "TRUMPvsHARRIS-OTC"
        ]
