...
class AsyncExnovaService:
    ...
    async def connect(self) -> bool:
        ...
        try:
            ...
            # ATUALIZADO: Espera mais tempo (até 20s) e pede ativamente o perfil.
            for _ in range(20): 
                # Pede ativamente o perfil para acelerar o processo
                await loop.run_in_executor(None, self.api.getprofile)
